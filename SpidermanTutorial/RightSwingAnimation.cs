...
public class RightSwingAnimation : MonoBehaviour
{
    public Spring spring;
    private LineRenderer lr;
    public RightSwing rightSwing;
    ...
    void DrawRope() {
        if (!rightSwing.IsSwinging())
        {
            currentSwingPosition = rightSwing.origin.position;
            spring.Reset();
        ...
        var swingPoint = rightSwing.GetSwingPoint();
        var originPosition = rightSwing.origin.position;
